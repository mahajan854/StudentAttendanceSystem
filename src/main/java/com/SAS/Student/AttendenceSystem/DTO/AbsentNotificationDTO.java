...
public class AbsentNotificationDTO {
	...
	public String toString() {
		return "AbsentNotificationDTO [id=" + id + ", dateSent=" + dateSent + ", method=" + method + ", reason="
				+ reason + ", studentId=" + studentId + ", getId()=" + getId() + ", getDateSent()=" + getDateSent()
				+ ", getMethod()=" + getMethod() + ", getReason()=" + getReason() + ", getStudentId()=" + getStudentId()
